...
namespace POSTerminalGui
{
    class Product
    {
        ...
        public Product(string name, string description, decimal price, Category productCategory, bool taxable)
        {
            Name = name;
        ...
        public static List<Product> ReadProducts()
        {
            ...
            while (line != null)
            {
                ...
                productList2.Add(new Product(productProps[0], productProps[1], decimal.Parse(productProps[2]), (Category)Enum.Parse(typeof(Category),productProps[3]), bool.Parse(productProps[4])));
